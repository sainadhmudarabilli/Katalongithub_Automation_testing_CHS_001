...
WebUI.selectOptionByValue(findTestObject('CHS_Pages_OR/Page_CURA Healthcare Service/facilityElement'), facilityElement, 
    true)

WebUI.delay(3)

WebUI.verifyOptionPresentByValue(findTestObject('CHS_Pages_OR/Page_CURA Healthcare Service/facilityElement'), 'Tokyo CURA Healthcare Center', 
    false, 0)
